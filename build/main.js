...
if (true) __webpack_require__(9).config();
...
const koaBody = __webpack_require__(26);
...
var iconv = __webpack_require__(46)
...
var raw = __webpack_require__(12);
var inflate = __webpack_require__(15);
...
lazyProperty(module.exports, 'callSiteToString', function callSiteToString () {
  ...
  return stack[0].toString ? toString : __webpack_require__(38)
})

lazyProperty(module.exports, 'eventListenerCount', function eventListenerCount () {
  return EventEmitter.listenerCount || __webpack_require__(39)
})
...
exports.json = __webpack_require__(18);
...
var typeis = __webpack_require__(29);
...
var typer = __webpack_require__(30)
...
var deprecate = __webpack_require__(36)('http-errors')
var setPrototypeOf = __webpack_require__(40)
var statuses = __webpack_require__(41)
...
var bomHandling = __webpack_require__(47),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(48); // Lazy load all encoding definitions.
...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __webpack_require__(58) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(13).concat(__webpack_require__(20)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(13).concat(__webpack_require__(20)) },
        gb18030: function() { return __webpack_require__(60) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(21).concat(__webpack_require__(62)) },
